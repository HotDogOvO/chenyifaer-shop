...
@TableName("t_app_recommend_images")
@ApiModel(value="AppRecommendImagesPO对象", description="小程序端 - 每日推荐图片表")
public class AppRecommendImagesPO extends Model<AppRecommendImagesPO> {
